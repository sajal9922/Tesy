...
VALUES (1, 'admin', encode(gen_random_bytes(10), 'base64'), 'Admin Dude', 'admin@email.com');

-- Generate a random password and hash it
INSERT INTO "people" ("role_id", "username", "passwd", "realname", "email")
VALUES (1, 'admin', crypt(encode(gen_random_bytes(10), 'base64'), gen_salt('bf')), 'Admin Dude', 'admin@email.com');
